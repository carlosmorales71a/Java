		...
		public void actionPerformed(ActionEvent event)
		{
			...
			for (i = 0; i < MAX_COUNT; i++)
			{
				...
				if (i > 0)
				{
					...
					// insert random numbers in index
	...
	private class SortListener implements ActionListener
	{
		public void actionPerformed(ActionEvent event)
		{
			...
			if (!donePopulate)
			{
				...
				// 'allNumbers' to array 'sortedNumber'
				// to set up a sort
