...
public class StudentTester {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null,
				firstName + "'s second test score is now " +
