...
public class QueueGUI extends JPanel {
	...
	private void enqueueShopper()
	{
		...
		if (aName.equals(""))
		{
			JOptionPane.showMessageDialog(null,
					"You must enter a shopper's name!",
					"Error!",
		...
		{
			JOptionPane.showMessageDialog(null,
					"You must enter a shopper's bill!",
					"Error!",
					JOptionPane.ERROR_MESSAGE);
			return;
		}
		...
		aPrice = Double.parseDouble(aPriceText);
			...
			// attempt to enqueue this new shopper's
			// name and bill
		...
		{
			JOptionPane.showMessageDialog(null,
					"Could not add new shopper '" +
					aName + "' to the queue " +
					"since it is full.\nYou " +
					"must dequeue a shopper!",
					"Error!",
					JOptionPane.ERROR_MESSAGE);
		}	// end else statement
	...
	private void dequeueShopper()
	{
		...
		{
			JOptionPane.showMessageDialog(null,
					"Could not dequeue a shopper " +
					"from the queue since it is " +
					"empty!",
					"Error!",
					JOptionPane.ERROR_MESSAGE);
		}	// end else statement
